...
<body>
  ...
  <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Nav Item - Dashboard -->
    <li class="nav-item active"><a class="nav-link" href="adminpage">
    ...
    <div class="sidebar-card d-none d-lg-flex">
      ...
      <p class="text-center mb-2">
        <strong>Tea House</strong> is packed with premium features, components, and more!
      </p>
      <a class="btn btn-success btn-sm" href="home">User Portal</a>
    </div>
